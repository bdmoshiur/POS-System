              ...
              <div class="card-body">
                    ...
                    <div class="form-group col-md-4">
                         ...
                         <select name="supplier_id" id="supplier_id" class="form-control select2">
                            <option value="{{ $purchase->supplier->id }}"> {{ isset($purchase->supplier)? $purchase->supplier->name : '' }}</option>
                         </select>
                    </div>
                    <div class="form-group col-md-4">
                         <label>Category Name</label>
                         <select name="category_id" id="category_id" class="form-control select2">
                            <option value="{{ $purchase->category->id }}"> {{ isset($purchase->category)? $purchase->category->name : '' }}</option>
                         </select>
                    </div>
                    <div class="form-group col-md-6">
                         <label>Product Name</label>
                         <select name="product_id" id="product_id" class="form-control select2">
                            <option value="{{ $purchase->product->id }}"> {{ isset($product)? $product->name : '' }}</option>
                         </select>
                    </div>
